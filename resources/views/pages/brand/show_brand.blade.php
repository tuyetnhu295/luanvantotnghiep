...
@section('content')
    ...
    <div class="container py-4">
        @if ($brand_info->banner)
            <div class="brand-banner mb-4">
                <img src="{{ asset('uploads/banner/brand/' . $brand_info->banner) }}" alt="Banner" class="img-fluid rounded">
            </div>
        @endif

        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h2 class="fw-bold">{{ $brand_info->brand_product_name }}</h2>
            </div>
            <div class="col-md-6 text-md-end">
                <form action="{{ url('/home/pages/brand/brand-product/' . $brand_info->slug_brand_product . '/filter') }}"
        ...
        <div class="row g-3">
            @foreach ($all_product as $product)
                @if ($product->brand_product_id == $brand_id)
