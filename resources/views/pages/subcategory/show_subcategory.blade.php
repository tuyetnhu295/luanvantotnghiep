...
@section('content')
    ...
    <div class="container py-4">
        @if ($subcategory_info->banner)
            <div class="brand-banner mb-4">
                <img src="{{ asset('uploads/banner/subcategory/' . $subcategory_info->banner) }}" alt="Banner"
        ...
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h2 class="fw-bold">{{ $subcategory_info->subcategory_product_name }}</h2>
            </div>
            <div class="col-md-6 text-md-end">
                <form
                    action="{{ url('/home/pages/subcategory/subcategory-product/' . $subcategory_info->slug_subcategory_product . '/filter') }}"
        ...
        <div class="row g-3">
            @foreach ($all_product as $product)
                @if ($product->subcategory_product_id == $subcategory_id)
